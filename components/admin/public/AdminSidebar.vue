    ...
    <ul class="d-flex flex-column p-0 w-100">
      ...
      <li class="py-1 px-2 w-100 right-to-left-animation">
        ...
        >
          ...
          <span class="ms-1 d-none d-sm-inline-block">افزودن کاربر</span>
        </nuxt-link>
      </li>
      ...
      <li class="py-1 px-2 w-100 right-to-left-animation delay-animation-2">
        ...
        >
          ...
          <span class="ms-1 d-none d-sm-inline-block">لیست کاربران</span>
        </nuxt-link>
      </li>
      ...
      <li class="py-1 px-2 w-100 right-to-left-animation delay-animation-8">
        ...
        >
          ...
          <span class="ms-1 d-none d-sm-inline-block">افزودن سفارش</span>
        </nuxt-link>
      </li>
      ...
      <li class="py-1 px-2 w-100 right-to-left-animation delay-animation-12">
        <nuxt-link
          to="/admin/email"
          exact-active-class="sidebar-axect-active"
          class="sidebar-link"
        >
          ...
          <span class="ms-1 d-none d-sm-inline-block">ایمیل</span>
        </nuxt-link>
      </li>

      <li class="py-1 px-2 w-100 right-to-left-animation delay-animation-14">
        <a
          exact-active-class="sidebar-axect-active"
          class="sidebar-link"
