...
export default {
  ...
  async asyncData({ $axios }) {
    const openTickets = await $axios.$get(`experts/api/ticket/list/open/`)
    const closeTickets = await $axios.$get(`experts/api/ticket/list/close/`)
