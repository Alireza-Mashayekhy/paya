<template>
  <div>
    <div class="headline-container">
      ...
      <nuxt-link to="/seller/ticket" class="btn btn-sm btn-back"
        >بازگشت</nuxt-link
      >
    </div>

    <!-- <div class="head mb-5">-</div> -->
    <div class="mb-5">
      <div v-for="message in messages" :key="message.id">
        <div v-if="message.role == 'expert'" class="card my-message mb-2">
  ...
  methods: {
    async onSubmit() {
      ...
      try {
        ...
        console.log(res)
        this.$router.push(`/seller/ticket/`)
      } catch (ex) {
        console.log(ex)
      }
    },
